...
import com.android.main_stay.fragment.RankingsList.OnListFragmentInteractionListener;

import com.android.main_stay.models.RankingsModel;
...
public class MyItemRecyclerViewAdapter extends RecyclerView.Adapter<MyItemRecyclerViewAdapter.ViewHolder> {
    ...
    public MyItemRecyclerViewAdapter(ArrayList<RankingsModel> items, OnListFragmentInteractionListener listener,Context mContext) {
        mValues = items;
        mListener = listener;
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        if(rankingsModel.getCurrent_user().equals("True")){
            holder.itemView.setBackgroundColor(Color.parseColor("#C2C4CA"));
            holder.mIdView.setBackgroundResource(R.drawable.circular_layout);
            holder.mIdView.setTextColor(Color.WHITE);
        }

        if( position == 0){
            holder.itemView.setBackgroundResource(R.drawable.rank_1_bg);
            holder.mIdView.setBackgroundResource(R.drawable.circular_layout);
            holder.mIdView.setTextColor(Color.WHITE);
        }
