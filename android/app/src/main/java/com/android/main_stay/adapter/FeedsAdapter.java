package com.android.main_stay.adapter;
...
import com.android.main_stay.Classes.Comments;
...
import static com.android.main_stay.utils.Utils.getYoutubeVideoId;

import androidx.cardview.widget.CardView;
import androidx.recyclerview.widget.RecyclerView;

/**
 * Created by nonstop on 21/10/17.
 */

public class FeedsAdapter extends RecyclerView.Adapter<FeedsAdapter.MyViewHolder> {

    private ArrayList<FeedsModel> FeedsList;
    FeedsAdapter.MyViewHolder.RecyclerViewClickListener listener;
    ...
    public static RelativeLayout relativeLayoutOverYouTubeThumbnailView;
    public String videoId;
    public static ImageView img_thumbnail, playButton;
    public static SharedPreferences sharedPref;


    public static class MyViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        public TextView post_title, post_created_at, post_description, txtcommentscount, button_toggle,txtlike_count;
        FeedsAdapter.MyViewHolder.RecyclerViewClickListener listener;
        public static ImageView imgbookmark,imglike;
        static ImageView imgshare;
        static ImageView imgcomments;
        static NetworkImageView post_image;
        static CardView card_view;
        public int like_count;


        public MyViewHolder(View view, FeedsAdapter.MyViewHolder.RecyclerViewClickListener listener) {
            super(view);
    ...
    public FeedsAdapter(ArrayList<FeedsModel> FeedsList, Context mContext) {
        this.FeedsList = FeedsList;
        FeedsAdapter.mContext = mContext;
    }

    @Override
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_feeds_list, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        final FeedsModel FeedsModel = FeedsList.get(position);
        ...
        if (FeedsModel.getLike_count() != null)
            holder.txtlike_count.setText(FeedsModel.getLike_count());

        if (FeedsModel.getIs_bookmarked() != null) {
            if (FeedsModel.getIs_bookmarked().contentEquals("1")) {
                MyViewHolder.imgbookmark.setImageDrawable(mContext.getDrawable(R.drawable.btn_bookmark_filled));
            } else {
                MyViewHolder.imgbookmark.setImageDrawable(mContext.getDrawable(R.drawable.btn_bookmark_unfilled));
            }
        }

        if (FeedsModel.getIs_liked() != null) {
            if (FeedsModel.getIs_liked().contentEquals("1")) {
                MyViewHolder.imglike.setImageDrawable(mContext.getDrawable(R.drawable.btn_like_filled));
            } else {
                MyViewHolder.imglike.setImageDrawable(mContext.getDrawable(R.drawable.btn_like_unfilled));
            }
        }
        ...
        if (FeedsModel.getHas_video().equals("True")) {
            ...
            MyViewHolder.post_image.setImageUrl(ImageUrl, App.getInstance().getImageLoader());
        ...
        MyViewHolder.imglike.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MyViewHolder.imglike.setEnabled(false);
                LikePost(position,holder);
            }
        });

        MyViewHolder.imgbookmark.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        MyViewHolder.imgshare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                try {
                    ...
                    String sAux = R2Values.Web.BASE_URL + "posts/" + FeedsList.get(position).getPost_id();
        ...
        holder.button_toggle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra("likecount",holder.like_count);
                intent.putExtra("holder_position", position);
                intent.putExtra("comment_count",Integer.parseInt(FeedsModel.getComment_count()));
                intent.putExtra("post_id", FeedsList.get(position).getPost_id());
                intent.putExtra("like_clicked",FeedsModel.getIs_liked());
    ...
    public void LikePost(final int position , final MyViewHolder holder) {
            ...
            public void onResponse(JSONObject response) {
                ...
                try {
                    ...
                    if (jsonobj.getString("status").equals("success")) {
                        ...
                        MyViewHolder.imglike.setEnabled(true);

                        int flag_count = 0;

                        Utils.makeToast(mContext,jsonobj.getString("message"));
                        ...
                        if (jsonobj.getString("message").contentEquals(mContext.getResources().getString(R.string.post_liked))) {
                            ...
                            holder.like_count = flag_count;

                        } else {
                            if(FeedsList.get(position).getLike_count().toString() != "0"){
                            flag_count = Integer.parseInt(FeedsList.get(position).getLike_count().toString()) - 1;
                            FeedsList.get(position).setLike_count(String.valueOf(flag_count));
    ...
    public void BookmarkPost(final int position) {
     ...
     //   {"email":"harsh@gmail.com","password":"harsh@12345","post_id":"12"}
