...
import com.erudito.mainstaypeople.utils.InputValidation;
    ...
    private void init() {
        ...
        txtforgotpassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String uriText =
                        "mailto:rajiv.m@consultmainstay.in" +
                                "?subject=" + Uri.encode("Regarding MainStay App - forgot password") +
                                "&body=" + Uri.encode("Hi, I want to use the MainStay app, but I have forgotten my password. Kindly send me password.");
        ...
        txttandc.setPaintFlags(txttandc.getPaintFlags() | Paint.UNDERLINE_TEXT_FLAG);
        txttandc.setOnClickListener(v -> {
            String url = "https://mainstayconsulting.in/privacy-policy/";
    ...
    private class RegisterForPushNotificationsAsync extends AsyncTask<Void, Void, Void> {
        protected Void doInBackground(Void... params) {
            try {
                ...
                new URL("http://13.202.229.238:8000/register/device?token=" + deviceToken).openConnection();
