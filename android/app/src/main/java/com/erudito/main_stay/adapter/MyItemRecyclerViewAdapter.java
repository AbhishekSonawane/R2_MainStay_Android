...
import com.erudito.main_stay.models.RankingsModel;
import com.erudito.main_stay.fragment.RankingsList;
...
public class MyItemRecyclerViewAdapter extends RecyclerView.Adapter<MyItemRecyclerViewAdapter.ViewHolder> {
    ...
    public MyItemRecyclerViewAdapter(ArrayList<RankingsModel> items, RankingsList.OnListFragmentInteractionListener listener, Context mContext) {
        mValues = items;
        mListener = listener;
